...
export class DataFieldMap {
    static toDisplayName(type: IndicatorParamType, fieldName: string) {
            return (this.field[type] && this.field[type][fieldName]) || fieldName;
    }
    ...
    static getDictionary(type: IndicatorParamType, fieldName: string) {
        return this.dictionary[type] && this.dictionary[type][fieldName];
    }

    static rfield: FieldMap = {};
    static get field(): FieldMap { return {
        1: { 
        'sales':'sales', 
        'netinc':'net income', 
        'cgs':'cost of goods', 
