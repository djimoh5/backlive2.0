...
Calculation = function() {
	...
	var values = null;
	var tables = [ "", "is", "bs", "cf", "snt", "mos", "tech", "macro", "shrt_intr", "is_gr", "fs", "fi" ]; 
    //tables[99] = "tickers";
    //tables[101] = "eurodo";
    var nonTickerTypes = [ParamType.Macro, 101];
	...
	this.cache = function(indicators, date, callback, ticker, inclTypes) {
	...
	this.init = function(eq, allowNeg) {
    	indicator = eq;
		params = [];
