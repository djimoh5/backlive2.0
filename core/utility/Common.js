...
var Common = {
    sendEmail: function(toEmail, subject, header, mainCol, leftCol, rightCol, actionBtn, linkAction) {
    ...
    sortKeysByValue: function(obj, sortDesc) {
        var sortArr = [];
        var sortDir;
    ...
    sortKeys: function(obj, sortDesc) {
        var sortArr = [];
        var sortDir;
    ...
    dateDiff: function(date1, date2, period) {
...
Date.prototype.format = function(format) {
    switch(format) {
        case 1: return parseInt(this.getFullYear() + Common.padMonth(this.getMonth() + 1) + Common.padMonth(this.getDate()));
        case 2: return Common.padMonth(this.getMonth() + 1) + '/' + Common.padMonth(this.getDate()) + '/' + this.getFullYear();
        case 3: 
            ...
            return Common.padMonth(this.getMonth() + 1) + '/' + Common.padMonth(this.getDate()) + '/' + this.getFullYear() 
                        + ' ' + Common.padMonth(hour) + ':' + Common.padMonth(this.getMinutes()) + ' ' + meridian;
        case 4: return this.getFullYear() + '-' + Common.padMonth(this.getMonth() + 1) + '-' + Common.padMonth(this.getDate());
        default: return parseInt(this.getFullYear() + Common.padMonth(this.getMonth() + 1) + Common.padMonth(this.getDate()));
    }	
}
