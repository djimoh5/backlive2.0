...
var ChartComponent = (function () {
    ...
    ChartComponent.prototype.init = function (callback, startDate, endDate) {
        this.chart = null;
    ...
    ChartComponent.prototype.showChartBtns = function (btn, btnGroup) {
    ...
    ChartComponent.prototype.allowMult = function () {
        return true; //$('.chart_allow_mult').hasClass('active');
    };
    ChartComponent.prototype.allowMultOff = function () {
        $('.chart_allow_mult').removeClass('active');
    };
    ChartComponent.prototype.allowMultOn = function () {
        $('.chart_allow_mult').addClass('active');
    };
    ChartComponent.prototype.isRelative = function () {
        return $('.chart_use_perc').hasClass('active');
    };
    ChartComponent.prototype.relativeOff = function () {
        $('.chart_use_perc').removeClass('active');
    };
    ChartComponent.prototype.relativeOn = function () {
        $('.chart_use_perc').addClass('active');
    };
    ChartComponent.prototype.create = function (tkr, id) {
    ...
    ChartComponent.prototype.clear = function (relative, callback) {
    ...
    ChartComponent.prototype.removeIndicator = function (id) {
        for (var tkr in this.indicators) {
            delete this.indicators[tkr][id];
        }
    };
    ChartComponent.prototype.addSearchChartSeries = function (span) {
    ...
    ChartComponent.prototype.addChartSeries = function (tkr, id, callback, btn) {
    ...
    ChartComponent.prototype.getSeriesName = function (name, id) {
    ...
    ChartComponent.prototype.loadTechIndicator = function (ti) {
        RM.ui.showMainView(false);
        var tkr = this.ticker;
        ...
        if (this.exists(tkr, key)) {
            ...
            switch (ti) {
                ...
                case 'boll':
                    ...
                    this.nextColor = '#12455a';
                    this.loadChartSeries(tkr, key, 'Boll Mid', true, 0);
                    this.nextColor = '#FF6633';
                    this.loadChartSeries(tkr, key + 'u', 'Boll Up', true, 0);
                    this.nextColor = '#FF6633';
                    this.loadChartSeries(tkr, key + 'l', 'Boll Low', true, 0);
                    break;
                case 'sma50':
                    if (!this.indicators[tkr][key])
                ...
                case 'donch':
                    ...
                    this.nextColor = '#4791a7';
                    this.loadChartSeries(tkr, key + 'u', 'Donchian High', true, 0);
                    this.nextColor = '#4791a7';
                    this.loadChartSeries(tkr, key + 'l', 'Donchian Low', true, 0);
                    break;
            }
            RM.modal.loading(false);
        }
    };
    ChartComponent.prototype.loadChartSeries = function (tkr, id, name, forceMultSeries, yAxis, navigator) {
    ...
    ChartComponent.prototype.loadChartSeriesHelper = function (tkr, id, name, yAxis, hasLowerY) {
        this.index = id;
    ...
    ChartComponent.prototype.getChartData = function (points, notDaily) {
        var start, end;
    ...
    ChartComponent.prototype.rangeSelect = function (range) {
        var start;
        if (range > 0) {
            start = new Date();
    ...
    ChartComponent.prototype.setDateRange = function (start, end) {
        $('#chart_min_date').val(start.format(2));
        $('#chart_max_date').val(end.format(2));
        this.chart.xAxis[0].setExtremes(start.getTime(), end.getTime());
        this.updateChartRange();
    };
    ChartComponent.prototype.reloadChart = function (callback) {
        this.initChart(false, callback);
    };
    ChartComponent.prototype.exists = function (tkr, id) {
        if (this.series[tkr] && this.series[tkr][id])
            return true;
        else
            return false;
    };
    ChartComponent.prototype.remove = function (tkr, id) {
        this.series[tkr][id].remove(true);
        delete this.series[tkr][id];
    };
    ChartComponent.prototype.updateChartRange = function () {
        var axis = [];
        for (var i = 0; i <= this.lowerAxis; i++) {
    ...
    ChartComponent.prototype.selectDate = function () {
    ...
    ChartComponent.prototype.getDataInRange = function (data) {
    ...
    ChartComponent.prototype.showRegimeBand = function () {
        ...
        if (regime == 'hv' || regime == 'lv') {
            ...
            $.each(data, function (i, vol) {
                ...
                else if ((useHVol && vol.val > threshH) || (!useHVol && vol.val < threshL)) {
            ...
            function plotBands() {
                ...
                while (start < end) {
                    ...
                    else if ((firstRet && ret1 > ret2) || (!firstRet && ret2 > ret1)) {
    ...
    ChartComponent.prototype.alignSeries = function (series1, series2) {
        var s1, s2, ns1 = [], ns2 = [];
    ...
    ChartComponent.prototype.showCorrelationMatrix = function () {
    ...
    ChartComponent.prototype.addNewsFlags = function (news) {
        var data = [];
        if (this.flagSeries) {
            try {
    ...
    ChartComponent.prototype.clickNewsFlag = function (lnk) {
    };
    ChartComponent.prototype.initChart = function (init, callback, startDate, endDate) {
    ...
    ChartComponent.prototype.createAxis = function () {
        //build number of yAxis allowed
        var yAxis = [{ gridLineColor: '#f3f3f3', opposite: false, startOnTick: false, endOnTick: false /*, type:'logarithmic'*/ }];
